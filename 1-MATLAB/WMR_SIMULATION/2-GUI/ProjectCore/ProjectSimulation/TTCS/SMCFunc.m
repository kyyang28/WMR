%
% @description: Design sliding mode controller
%
% @Author: Yankun Yang
...
% Step 3: Define sliding surfaces
% sigma_1 = K1 * xe
...
% F_qe = [v_r*cos(theta_e); v_r*sin(theta_e); w_r]
F_qe = [ur(1)*cos(x_e(3)); ur(1)*sin(x_e(3)); ur(2)];
...
% Notes: T_G = rho
%        F_tx = T_F(partial derivative) * F_qe
