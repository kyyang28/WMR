 ...
 *  eta[0] and eta[1] are reaching gains of sliding surfaces
 *  eps[0] and eps[1] are boundary layer parameters
 *  WARNING: Setup some big numbers to eta parameters will lead to chattering effect
 *           e.g. eta[0] = 10 and eta[1] = 10
 */
